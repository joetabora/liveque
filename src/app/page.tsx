...
const buttonPrimary =
  "inline-flex items-center gap-3 bg-harley-orange hover:bg-harley-orange-dark text-white font-bold text-lg uppercase tracking-wider px-10 py-5 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-harley-orange/30 active:scale-95";

const buttonSecondary =
  "inline-flex items-center gap-3 bg-iron-panel border border-iron-border hover:border-harley-orange/50 text-white hover:text-harley-orange font-bold text-lg uppercase tracking-wider px-10 py-5 rounded-2xl transition-all duration-200 active:scale-95";
...
export default function HomePage() {
  const portraitDisplayUrl = `/${LEGACY_TENANT_SLUG}/display/portrait?kiosk=1`;
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-8 text-center">
        ...
        >
          ...
          <div className="mt-12 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4">
            <Link href="/display" className={buttonPrimary}>
              <DisplayIcon />
              Display Screen
            </Link>

            <Link href={portraitDisplayUrl} className={buttonSecondary}>
              <PortraitDisplayIcon />
              Display Portrait
            </Link>
